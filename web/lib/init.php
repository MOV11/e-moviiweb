...
$demos = array(
  'default' => array(
    'body_class' => 'header-light sidebar-dark sidebar-expand',
    'sidebar_file' => 'partials/sidebar',
    'nav_file' => 'partials/nav-dark'
  ),
  'collapsed_nav' => array(
    'body_class' => 'header-dark sidebar-light sidebar-collapse',
    'sidebar_file' => 'partials/sidebar-light',
    'nav_file' => 'partials/nav'
  ),
  'horizontal_nav' => array(
    'body_class' => 'sidebar-horizontal',
    'sidebar_file' => 'partials/sidebar-horizontal',
    'nav_file' => 'partials/nav'
  ),
  'horizontal_nav_icons' => array(
    'body_class' => 'header-centered sidebar-horizontal',
    'sidebar_file' => 'partials/sidebar-horizontal-icons',
    'nav_file' => 'partials/nav'
  ),
  'ecommerce' => array(
    'body_class' => 'sidebar-light sidebar-expand',
    'sidebar_file' => 'partials/sidebar-light',
    'nav_file' => 'partials/nav',
    'color_scheme' => 'purple',
  ),
...
$GLOBALS['enable_livereload'] = false;
$GLOBALS['enable_relative_nav'] = true;
activate_demo( 'real_estate', $demos );
...
// CSS
register_style( 'bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css');
...
enqueue_style( 'sweet-alert', 'https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.6.4/sweetalert2.css');
enqueue_style( 'magnific-popup', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.min.css' );
...
register_style( 'dragula', 'https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.css');
enqueue_style( 'mediaelement', 'https://cdnjs.cloudflare.com/ajax/libs/mediaelement/4.1.3/mediaelementplayer.min.css' );
...
enqueue_style( 'nunito-font', 'https://fonts.googleapis.com/css?family=Nunito+Sans:400,600,700' );
enqueue_style( 'roboto-font', 'https://fonts.googleapis.com/css?family=Roboto:300,400,400i,500,700' );
enqueue_style( 'open-sans-font', 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600');
...
// JS
enqueue_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js' );
register_script( 'jqueryui', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js' );
enqueue_script( 'tether', 'https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.0/js/tether.min.js' );
enqueue_script( 'bootstrap', $js . '/bootstrap.min.js' );
enqueue_script( 'magnific-popup', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js' );
...
register_script( 'counterup', 'https://cdnjs.cloudflare.com/ajax/libs/Counter-Up/1.0.0/jquery.counterup.min.js' );
register_script( 'waypoints', 'https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.min.js' );
register_script( 'validator', 'https://cdnjs.cloudflare.com/ajax/libs/1000hz-bootstrap-validator/0.11.9/validator.min.js' );
...
enqueue_script( 'mediaelement', 'https://cdnjs.cloudflare.com/ajax/libs/mediaelement/4.1.3/mediaelementplayer.min.js');
...
enqueue_script( 'sweet-alert', 'https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.6.4/sweetalert2.min.js' );
