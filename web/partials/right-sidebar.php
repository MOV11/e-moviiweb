    ...
    <div class="chat-list">
      ...
      <div class="list-group row">
        <a href="javascript:void(0)" class="list-group-item user--online thumb-xs" data-chat-user="Julein Renvoye">
          ...
          <span class="name">Julien Renvoye</span>
        ...
        <a href="javascript:void(0)" class="list-group-item user--online thumb-xs" data-chat-user="Eddie Lebanovkiy">
          ...
          <span class="name">Eddie Lebanovskiy</span>
        ...
        <a href="javascript:void(0)" class="list-group-item user--away thumb-xs" data-chat-user="Cameron Moll">
          ...
          <span class="name">Cameron Moll</span>
        ...
        <a href="javascript:void(0)" class="list-group-item user--busy thumb-xs" data-chat-user="Bill S Kenny">
          <img src="assets/demo/users/user7.jpg" class="img-circle" alt="" />
          <span class="name">Bill S Kenny</span>
        ...
        <a href="javascript:void(0)" class="list-group-item user--busy thumb-xs" data-chat-user="Trent Walton">
          ...
          <span class="name">Trent Walton</span>
...
<div class="chat-panel" hidden>
  <div class="card">
    ...
    <div class="card-header">
      ...
      <button type="button" class="minimize" aria-label="Minimize"><span aria-hidden="true"><i class="material-icons">expand_more</i></span></button>
    ...
    <div class="card-block custom-scroll">
      ...
      <form action="javascript:void(0)" method="post">
        ...
        <ul class="list-unstyled list-inline chat-extra-buttons">
          <li class="list-inline-item"><a href="javascript:void(0)"><i class="material-icons">insert_emoticon</i></a></li>
          <li class="list-inline-item"><a href="javascript:void(0)"><i class="material-icons">attach_file</i></a></li>
        </ul>
        <button class="btn btn-color-scheme btn-circle submit-btn" type="submit"><i class="material-icons">send</i></button>
      </form>
