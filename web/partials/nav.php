...
<nav style="background-color: #3cd173" class="navbar">

  <!-- Logo Area -->
  <div class="navbar-header">
    <a href="index.php" style="background-color: #3cd173" class="navbar-brand text-center">
      <img style="width: 150px; max-width: 1000%; position: relative; left: 60px;" class="logo-collapse" alt="" src="assets/demo/logo-collapse.png" />
      <!-- <p>OSCAR</p> -->
    </a>
  </div><!-- /.navbar-header -->
  ...
  <ul class="nav navbar-nav hidden-sm-down">
      ...
      <div class="dropdown-menu dropdown-left dropdown-card animated flipInY">
        <div class="card">
          <header class="card-header">
            New messages <span class="mr-l-10 badge badge-border bg-primary">3</span>
          </header>
    ...
    <li class="dropdown">
      <a href="#" class="dropdown-toggle ripple" data-toggle="dropdown">
        ...
        <span class="badge badge-pill bg-primary">9</span>
      </a>

      <div class="dropdown-menu dropdown-left dropdown-card animated flipInY">
        <div class="card">
          <header class="card-header">
            New notifications <span class="mr-l-10 badge badge-border bg-primary">4</span>
          </header>
      ...
      <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-wide">
        <div class="card">
          ...
          <section class="card-header">
            New notifications <span class="badge badge-border bg-danger mr-l-10">4</span>
          </section>
