			...
			<li class="current-page menu-item-has-children">
				<a href="javascript:void(0);" class="ripple">
					...
					<span class="hide-menu">
						Dashboard
						<span class="badge badge-border badge-border-inverted bg-primary pull-right">5</span>
					</span>
				</a>
          ...
          <?php endif; ?>
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);" class="ripple">
					...
					<span class="hide-menu">
						UI Elements
						<span class="badge badge-border badge-border-inverted bg-primary pull-right">9</span>
					</span>
				</a>
				<ul class="list-unstyled sub-menu">
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);" class="ripple">
					...
					<span class="hide-menu">
						Sample Pages
						<span class="badge badge-border badge-border-inverted bg-info pull-right">3</span>
					</span>
				</a>
				<ul class="list-unstyled sub-menu">
