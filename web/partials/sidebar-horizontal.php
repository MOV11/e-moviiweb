		...
		<ul class="nav in side-menu">
			<li class="current-page menu-item-has-children">
				<a href="javascript:void(0);">
					<span class="hide-menu">Dashboard <span class="badge badge-border bg-primary pull-right">5</span></span>
				</a>
          ...
          <?php endif; ?>
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);">
					<span class="color-color-scheme"><span class="hide-menu">Apps</span></span>
				</a>
				<ul class="list-unstyled sub-menu">
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);"><span class="hide-menu">Forms</span></a>
				<ul class="list-unstyled sub-menu">
			...
			<li class="menu-item-has-children">
			  <a href="javascript:void(0);"><span class="hide-menu">Charts</span></a>
			  <ul class="list-unstyled sub-menu">
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);">
					<span class="hide-menu">UI Elements <span class="badge badge-border bg-primary pull-right">7</span></span>
				</a>
			...
			<li class="menu-item-has-children">
				<a href="javascript:void(0);">
					<span class="hide-menu">Sample Pages <span class="badge badge-border bg-info pull-right">13</span></span>
				</a>
				<ul class="list-unstyled sub-menu">
