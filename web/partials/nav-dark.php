...
<nav class="navbar">
  ...
  <!-- Search Form -->
  <form class="navbar-search hidden-xs-down" role="search">
  ...
  <!-- Button: Create New -->
  <div class="btn-list dropdown hidden-xs hidden-sm-down">
    ...
    <div class="dropdown-menu dropdown-left animated flipInY">
      ...
      <a class="dropdown-item" href="#">
        <i class="material-icons list-icon icon-muted pull-right">settings</i>
  ...
  <ul class="nav navbar-nav hidden-sm-down">
    <li class="dropdown">
      <a href="javascript:void(0);" class="dropdown-toggle ripple" data-toggle="dropdown">
        ...
        <span class="badge badge-border bg-primary">3</span>
      </a>

      <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-dark animated flipInY">
        <div class="card">
          <header class="card-header">
            New messages <span class="mr-l-10 badge badge-border badge-border-inverted bg-primary">3</span>
          </header>
          ...
          <ul class="list-unstyled dropdown-list-group">
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  ...
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">I slowly updated my Behance with some recent projects ...</span>
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="media">
                <span class="d-flex user--offline thumb-xs">
      						<img src="assets/demo/users/user6.jpg" class="img-circle" alt="">
                </span>

                <span class="media-body">
                  <span class="media-heading">Emily Lee</span>
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">Hi John!</span>
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  <span class="media-heading">Christopher Palmer</span>
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">Like the illustration and the indicator style. Best of luck ...</span>
                </span>
              </a>
            </li>
    ...
    <li class="dropdown">
      <a href="#" class="dropdown-toggle ripple" data-toggle="dropdown">
        ...
        <span class="badge badge-border bg-primary">9</span>
      </a>

      <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-dark animated flipInY">
        <div class="card">
          <header class="card-header">
            New notifications <span class="mr-l-10 badge badge-border badge-border-inverted bg-primary">4</span>
          </header>
            ...
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  ...
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">Your invitation for Mars has been accepted ...</span>
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  ...
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">Meeting with Nathan McCullum on Friday 8 AM ... </span>
                </span>
              </a>
            </li>
    ...
    <li>
      <a href="javascript:void(0);" class="right-sidebar-toggle ripple">
    ...
    <li class="dropdown">
      ...
      <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-wide dropdown-card-dark text-inverse">
        <div class="card">
          <header class="card-heading-extra">
            <div class="row">
              ...
              <div class="col-4 d-flex justify-content-end">
                <a href="logout.php" class="mr-t-10">
          ...
          <section class="card-header text-inverse">
            New notifications <span class="badge badge-border badge-border-inverted bg-danger mr-l-10">4</span>
          </section>
            ...
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  <span class="media-heading">Steve Smith</span>
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">I slowly updated my Behance with some recent projects and finally added a case study for thus great project ...</span>
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="media">
                ...
                <span class="media-body">
                  <span class="media-heading">To Do</span>
                  <small>10.14.2016 @ 2:30pm</small>
                  <span class="media-content">Meeting with Nathan McCullum on Friday 8 AM to discuss about an ongoing project ... </span>
                </span>
              </a>
            </li>
