...
<body<?php body_class() ?> style="background-image: url(assets/demo/night.jpg)">
	<div id="wrapper" class="row wrapper multi-step-signup">
		...
		<!-- Register Form -->
    <div class="col-12 col-sm-6 col-md-4 offset-md-4 login-center">
			<form id="multi-step-signup" class="multi-step-form overflow-hidden" action="javascript:void(0)" method="post">
				<fieldset id="signup-step-1" class="form-horizontal form-material active animated fadeInRight">
            ...
            <div class="checkbox checkbox-info">
              <label>
                ...
                <span class="label-text">I agree to all <a href="#">Terms &amp; Conditions</a></span>
					...
					<div class="form-group">
            <button class="btn btn-info btn-block ripple next-btn">Sign Up</button>
					</div>
				</fieldset>

				<fieldset id="signup-step-2" class="form-horizontal form-material animated fadeInRight">
            ...
            <label>Google Plus</label>
					...
					<div class="form-group row text-center">
						...
						<div class="col-6">
							<button class="btn btn-info btn-block ripple next-btn">Next</button>
						</div>
					</div>
				</fieldset>

				<fieldset id="signup-step-3" class="form-horizontal form-material animated fadeInRight">
            ...
            <label>Address</label>
					...
					<div class="form-group row text-center">
						...
						<div class="col-6">
							<button class="btn btn-info btn-block ripple" type="submit">Submit</button>
						</div>
					</div>
				</fieldset>
			</form>
