  ...
  var Custom = {
    ...
    productLineHomeMorrisChart: function() {
      ...
      var chart = Morris.Area({
        ...
        parseTime: false,
        xkey: 'period',
        ykeys: ['pe', 'bike', 'patinete', 'metro', 'trem', 'onibus', 'vlt'],
        labels: ['A pé', 'Bike', 'Patinete', 'Metrô', 'Trem', 'Ônibus', 'VLT'],
        ymax: 'auto[100]',
        ymin: 'auto[0]',
        pointSize: 3,
        xLabelAngle: 50,
        fillOpacity: 0,
        pointStrokeColors:['#00bfc7', '#fb9678', '#9675ce', '#990000', '#33cc33', '#e6e600', '#3980b5'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 1,
        hideHover: 'auto',
        lineColors: ['#00bfc7', '#fb9678', '#9675ce', '#990000', '#33cc33', '#e6e600', '#3980b5'],
        resize: true
      });
    ...
    donuteMorrisChartDemo: function() {
      ...
      var chart = Morris.Donut({
        ...
        resize: true,
        colors:['#00bfc7', '#fb9678', '#9675ce']
      });

      $(document).on('SIDEBAR_CHANGED_WIDTH', chart.resizeHandler);
    },

    donuteMorrisChartDemo1: function() {
      var ctx = document.getElementById("donuteMorrisDemo1");
      if ( ctx === null ) return;

      var chart = Morris.Donut({
        element: 'donuteMorrisDemo1',
        data: [{
          label: "Metrô",
          value: 50,
        }, {
        ...
        resize: true,
        colors:['#990000', '#33cc33', '#e6e600', '#3980b5']
      });
